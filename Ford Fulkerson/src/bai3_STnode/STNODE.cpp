...
// BFS tìm du?ng di t? s d?n t
// Tr? v? danh sách các d?nh trên du?ng di
...
int main() {
    ...
    // Luu l?i v? trí c?a d?nh trên du?ng di
    vector<int> pos(n, -1);
    ...
    int r = -1, res = 0;
    for (int u: path) {
        // N?u t? các d?nh tru?c u có th? di t?i m?t
        // d?nh sau u thì u không xung y?u, ngu?c l?i
        // u là nút xung y?u.
